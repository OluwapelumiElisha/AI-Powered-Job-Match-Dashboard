...
const JobDetailsModal: React.FC = () => {
  const { selectedJob, setSelectedJob, calculateMatchScore, applyForJob } = useJobs();
  const { user } = useAuth();
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div className="bg-white p-6 rounded-lg w-full max-w-md">
        ...
        {/* div that is displaying the required skills */}
        <div className="mt-4">
        ...
        {/* div that is displaying the Match Score */}
        <div className="mt-4">
        ...
        <div className="mt-4 flex justify-end space-x-2">
          ...
          <button
            onClick={() => applyForJob(selectedJob.id, user.skills)}
